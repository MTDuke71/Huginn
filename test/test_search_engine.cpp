...
int main() {
    std::cout << "=== HUGINN SEARCH ENGINE TEST ===" << std::endl;
    ...
    std::cout << "  Best move: " << Huginn::SimpleEngine::move_to_uci(best_move1) << std::endl;
    ...
    std::cout << "Search result:" << std::endl;
    std::cout << "  Best move: " << Huginn::SimpleEngine::move_to_uci(best_move2) << std::endl;
    std::cout << "  Nodes: " << engine.get_stats().nodes_searched << std::endl;
    std::cout << "  Time: " << engine.get_stats().time_ms << "ms" << std::endl;
    std::cout << "  Max depth: " << engine.get_stats().max_depth_reached << std::endl;
    std::cout << "  PV: " << Huginn::SimpleEngine::pv_to_string(engine.get_pv()) << std::endl;
    ...
    std::cout << "Search result:" << std::endl;
    std::cout << "  Best move: " << Huginn::SimpleEngine::move_to_uci(best_move3) << std::endl;
    std::cout << "  Nodes: " << engine.get_stats().nodes_searched << std::endl;
    std::cout << "  Time: " << engine.get_stats().time_ms << "ms" << std::endl;
    std::cout << "  Max depth: " << engine.get_stats().max_depth_reached << std::endl;
    std::cout << "  PV: " << Huginn::SimpleEngine::pv_to_string(engine.get_pv()) << std::endl;
