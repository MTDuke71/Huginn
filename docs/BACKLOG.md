...
| 59 | En-passant key semantics (repetition + Polyglot) | **FIXED on main (2026-07-11)** — EP right normalized at source (MakeMove + set_from_fen, X-FEN convention); Polyglot wrong-rank check replaced, spec anchor keys pass; unconditional (#50 precedent), SPRT vs t28 as regression gate | bug/rules/book | high |
