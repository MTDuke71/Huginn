...
int main() {
    ...
    int eval2 = engine.evalPosition(pos);
    std::cout << "If Black had played 1...Nc6 instead: " << eval2 << std::endl;
    std::cout << "Development advantage: " << (eval2 - eval1) << " centipawns" << std::endl;
    
    // Note: Game phase detection moved to MinimalEngine internal evaluation
    std::cout << "Evaluation uses stable MinimalEngine (HybridEvaluator removed for safety)" << std::endl;
