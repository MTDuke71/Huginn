...
REM on the 13700K.
REM
REM Usage: test_huginn_vs_t6.bat [rounds]   (default: 100 rounds = 200 games)
...
echo.
echo [Intel 13700K] Running %ROUNDS% rounds (= %ROUNDS%*2 games): Huginn current vs huginn_t6 tc=10+0.1
echo.
