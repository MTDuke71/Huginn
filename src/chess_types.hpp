...
EVAL_PARAM std::array<int, size_t(PieceType::_Count)> PIECE_VALUES_MG = { 0, 95, 391, 382, 527, 1188, 20000 };
...
EVAL_PARAM std::array<int, size_t(PieceType::_Count)> PIECE_VALUES_EG = { 0, 97, 291, 316, 574, 1067, 20000 };
