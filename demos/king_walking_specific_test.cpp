...
int main() {
    ...
    int eval3 = Evaluation::evaluate_position(pos3);
    ...
    int eval4 = Evaluation::evaluate_position(pos4);
    ...
    int eval5 = Evaluation::evaluate_position(pos5);
    ...
    int eval_normal = Evaluation::evaluate_position(normal);
