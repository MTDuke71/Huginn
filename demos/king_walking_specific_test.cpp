...
int main() {
    ...
    int eval3 = Huginn::HybridEvaluator::evaluate(pos3);
    ...
    int eval4 = Huginn::HybridEvaluator::evaluate(pos4);
    ...
    int eval5 = Huginn::HybridEvaluator::evaluate(pos5);
    ...
    int eval_normal = Huginn::HybridEvaluator::evaluate(normal);
