...
int main() {
    ...
    std::cout << "Total: " << Huginn::HybridEvaluator::evaluate(pos1) << "cp\n";
    std::cout << "(Unified evaluation - individual components not exposed)\n\n";
    
    std::cout << "MIRRORED POSITION (Black to move):\n";
    std::cout << "FEN: 8/8/8/3k4/3p4/3P4/2K1P3/8 b - - 0 1\n";
    std::cout << "Total: " << Huginn::HybridEvaluator::evaluate(pos2) << "cp\n";
    std::cout << "(Unified evaluation - individual components not exposed)\n\n";
    
    std::cout << "DIFFERENCES:\n";
    std::cout << "Total Difference: " << (Huginn::HybridEvaluator::evaluate(pos1) - Huginn::HybridEvaluator::evaluate(pos2)) << "cp\n";
