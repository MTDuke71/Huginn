...
// Huginn2 Perft function - OPTIMIZED V1: Inline move generation to reduce function call overhead
static uint64_t perft_huginn2(Position& pos, int depth) {
    ...
    // OPTIMIZATION V1: Inline move generation instead of wrapper function call
    // Use bitboard move generation - inlined for performance
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "=== Huginn2 Perft Suite OPTIMIZED V1 (Inlined Move Gen) ===" << std::endl;
    std::cout << "Testing optimized bitboard move generation against comprehensive perft suite" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "  Method: Huginn2 optimized bitboard move generation (V1)" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "Will run approximately " << total_expected_tests << " tests using Huginn2 optimized bitboard generation (V1)" << std::endl;
    std::cout << "========================================" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "Test method: Huginn2 optimized bitboard move generation (V1)" << std::endl;
