...
| 58 | Make SEE sound before using it for hard pruning | **CANDIDATE (2026-07-11)** — first-recapture pin filter behind `ENABLE_SEE_LEGALITY` (default OFF, byte-identical off); branch `candidate/see-legality`; AMD leg ~neutral (+5.56 ± 15.11, LOS 76%, 1000g cap) — park / Intel leg / correctness-ship pending user call (arm signatures in SPRT_QUEUE_TEST_PLAN.md: OFF d14 = 7,484,807; ON d14 = 7,128,502 / e2e4; discriminator test SeePinnedDefenderRecapture) | bug/search | high |
