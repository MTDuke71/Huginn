...
| 62 | Singular extensions (SF18-study EBF lever) | **CANDIDATE (2026-07-12)** — behind `ENABLE_SINGULAR_EXT` (default OFF, byte-identical off); branch `candidate/singular-ext`; SPRT Intel leg positive (+17.39 ± 14.67, LOS 99.01%, 1000g cap), AMD leg pending | feature/search | high |
...
by-design skip). **Intel leg (2026-07-12): positive, CI excludes zero —
+17.39 ± 14.67, LOS 99.01%, 1000g cap (LLR 1.70, no bound), 52.50%
(W266/L216/D518), Ptnml [18,120,190,138,34], clean 1h49m run.** AMD leg
