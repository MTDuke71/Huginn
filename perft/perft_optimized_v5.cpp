...
// OPTIMIZATION V5: Custom fast move generation with reduced overhead
namespace FastMoveGen {
    inline void generate_knight_moves_fast(const Position& pos, S_MOVELIST& list, Color us) {
        ...
        while (knights != 0) {
            ...
            // Bulk process captures and quiet moves
    ...
    inline void generate_all_moves_optimized(const Position& pos, S_MOVELIST& list, Color us) {
        list.count = 0;
        
        // Use optimized knight generation, standard for others
        generate_knight_moves_fast(pos, list, us);
...
// Huginn2 Perft function - OPTIMIZED V5: Enhanced move generation with reduced overhead
static uint64_t perft_huginn2(Position& pos, int depth) {
    ...
    // OPTIMIZATION V5: Use custom optimized move generation
    FastMoveGen::generate_all_moves_optimized(pos, list, us);
    
    // OPTIMIZATION V5: Enhanced depth 1 handling (inherited from V3)
    if (depth == 1) {
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "=== Huginn2 Perft Suite OPTIMIZED V5 (Enhanced Move Generation) ===" << std::endl;
    std::cout << "Testing optimized perft with enhanced move generation and reduced overhead" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "  Method: Huginn2 optimized perft with enhanced move generation (V5)" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "Will run approximately " << total_expected_tests << " tests using optimized perft with enhanced move generation (V5)" << std::endl;
    std::cout << "========================================" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "Test method: Huginn2 optimized perft with enhanced move generation (V5)" << std::endl;
